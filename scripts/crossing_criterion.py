...
k-step predictions from s_i, s_j under the logged actions (the arbiter's actual input).
  ...
  python scripts/crossing_criterion.py --env_name=scene-play-v0 --n_chunks=10 --k=10
"""
import json
import os
import sys
...
flags.DEFINE_string('data_root', '/scratch/jwquan/ogbench_100m', 'Root holding <env>-100m-v0/<env>-NNN.npz chunks.')
